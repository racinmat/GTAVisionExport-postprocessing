...
def get_conn():
    """
    :rtype: postgresql.api.Connection
    """
...
def process(pixel_path, base_data_dir, session):
    ...
    # copeid and modified query for sample data
    sample_names = glob.glob(base_data_dir + '/*[0-9].tiff', recursive=False)
...
if __name__ == "__main__":
    ...
    #if args.save:
        #upload(results, Path(args.pixel_path))
